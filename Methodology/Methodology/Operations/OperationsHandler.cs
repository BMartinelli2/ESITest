...
namespace EsiTest.Methodology.Operations
{
    ...
    public class OperationsHandler : IOperationHandler
    {
        ...
        private const string ConsoleHeaderMessage = "Object Oriented programming and SOLILD examples. Type 'help' for a list of available commands or 'quit' to exit the application.";
        ...
        public OperationsHandler(List<IOperation> operations)
        {
            _operations = new Dictionary<string, IOperation>();
            LoadOperations(operations);
        }

        private void LoadOperations(List<IOperation> operations)
        {
